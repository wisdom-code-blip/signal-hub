...
const PERKS = [
  {
    icon: "⚡",
    title: "Early Access",
    desc: "Be first to access premium features before public launch",
  },
  {
    icon: "💸",
    title: "Founder Pricing",
    desc: "Locked-in discount of 40% off all future premium plans",
  },
  {
    icon: "🎯",
    title: "Priority Support",
    desc: "Direct line to our team. Your feedback shapes the product",
  },
  {
    icon: "🏆",
    title: "Founding Badge",
    desc: 'Exclusive "Founding Member" badge on your profile forever',
  },
];
...
const COMING_SOON = [
  {
    icon: "🤖",
    title: "AI Signal Grading",
    desc: "Automated quality scoring on every signal posted",
    eta: "Q3 2026",
  },
  {
    icon: "📱",
    title: "Mobile App",
    desc: "iOS and Android app with push notifications for new signals",
    eta: "Q3 2026",
  },
  {
    icon: "📊",
    title: "Portfolio Tracker",
    desc: "Track all your signal results in one unified dashboard",
    eta: "Q4 2026",
  },
  {
    icon: "🔔",
    title: "Signal Alerts",
    desc: "Telegram + WhatsApp alerts when your favorite providers post",
    eta: "Q4 2026",
  },
  {
    icon: "👥",
    title: "Social Following",
    desc: "Follow providers and build your personal signal feed",
    eta: "Q1 2027",
  },
  {
    icon: "🌍",
    title: "Naira Payments",
    desc: "Pay and withdraw directly in NGN via Paystack",
    eta: "Q3 2026",
  },
];
      ...
      <nav className="sticky top-0 z-50 border-b border-[#1f1f1f] bg-[#080808]/90 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/signup"
              className="px-4 py-2 bg-orange-500 hover:bg-orange-400 text-white text-sm font-semibold rounded-lg transition-all"
            >
              Sign Up
            </Link>
          </div>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-20 pb-16 text-center">
          ...
          >
            ...
            <span className="text-xs text-orange-300 font-mono tracking-wide">
              🔥 PREMIUM FEATURES DROPPING SOON
            </span>
          </motion.div>
          ...
          >
            AI signal grading, mobile app, portfolio tracker, Naira payments and
            more. Join the waitlist and lock in founder pricing.
          </motion.p>
              ...
              {!joined ? (
                ...
                >
                        ...
                        [
                          {
                            key: "buyer",
                            label: "📈 Buy Signals",
                            desc: "Get profitable signals",
                          },
                          {
                            key: "provider",
                            label: "💰 Sell Signals",
                            desc: "Monetize my analysis",
                          },
                        ] as const
                      ).map((opt) => (
                        <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <button
                      type="submit"
                      disabled={submitting || !role || !email}
          ...
          >
            <div className="flex -space-x-2">
              {["🧑", "👩", "👨", "🧑", "👩"].map((e, i) => (
                <div
                  key={i}
                  className="w-7 h-7 rounded-full bg-gradient-to-br from-orange-500 to-red-600 border-2 border-[#080808] flex items-center justify-center text-xs"
                >
                  {e}
                </div>
              ))}
            ...
            <p className="text-zinc-500 text-xs font-mono">
              <span className="text-white font-semibold">1,847 traders</span>{" "}
              already on the list
            </p>
          </motion.div>
        </section>
          ...
          <div className="bg-[#111] border border-orange-500/20 rounded-3xl p-10 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-zinc-400 text-sm mb-6 font-mono">
                Spots are limited. Join now and lock in your founding member
                perks before they're gone.
              </p>
              {!joined ? (
                <button
                  onClick={() =>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="border-t border-[#1f1f1f] pt-6 text-center">
              <Link href="/" className="inline-flex items-center gap-2 mb-4">
                <div className="w-6 h-6 bg-orange-500 rounded-md flex items-center justify-center font-bold text-white text-[10px]">
                  S
                </div>
              ...
              <p className="text-zinc-700 text-xs font-mono">
                © 2026 SignalHub. Not financial advice.
              </p>
            </div>
          </div>
        </footer>
