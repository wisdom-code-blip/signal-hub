...
const REQUIREMENTS = [
  {
    ...
    desc: "Minimum 50 posted signals with provable results",
  },
  {
    icon: "🎯",
    title: "75%+ Win Rate",
    desc: "Sustained win rate over at least 30 days",
  },
  {
    icon: "📅",
    title: "30+ Days Active",
    desc: "Account must be active for at least one month",
  },
  {
    icon: "💳",
    title: "Completed KYC",
    desc: "Identity verification via valid government ID",
  },
];
...
const BENEFITS = [
  {
    ...
    desc: "Blue checkmark on your profile and all signals",
    color: "text-blue-400",
  ...
  },
  {
    ...
    desc: "Your signals appear at the top of search results",
  ...
  },
  {
    ...
    desc: "Verified providers earn 3x more on average",
  ...
  },
  {
    icon: "🛡",
    title: "Trust Signal",
    desc: "Buyers are 5x more likely to purchase from verified providers",
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-20">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-1.5 mb-6">
            <span className="text-blue-400 text-xs font-mono tracking-wide">
          ...
          <p className="text-zinc-400 text-lg max-w-xl mx-auto leading-relaxed">
            Stand out from the crowd. Verified providers earn more, get better
            visibility, and build lasting trust with buyers.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {REQUIREMENTS.map((req, i) => (
                ...
                >
                  <div className="w-10 h-10 bg-[#1a1a1a] rounded-xl flex items-center justify-center text-xl flex-shrink-0">
                    {req.icon}
                  </div>
                  <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    <span className="text-[10px] font-mono text-orange-500 font-bold w-5">
                      {item.step}
                    </span>
          ...
          <div>
            ...
            {!submitted ? (
              <form
                ...
                className="bg-[#111] border border-[#1f1f1f] rounded-2xl p-6 space-y-4"
              >
                {[
                  {
                    label: "FULL NAME",
                  ...
                  },
                  {
                    label: "PROVIDER NAME",
                    key: "providerName",
                    placeholder: "Your SignalHub username",
                    type: "text",
                  },
                ].map((field) => (
                  <div key={field.key}>
              ...
              >
                ...
                <Link
                  href="/provider"
                  className="inline-block bg-orange-500 hover:bg-orange-400 text-white font-display font-bold px-6 py-3 rounded-xl transition-all text-sm"
                >
                  Back to Dashboard →
                </Link>
              </motion.div>
