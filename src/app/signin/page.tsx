  ...
  return (
    <div className="min-h-screen bg-[#080808] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-red-600/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-500 text-sm mt-1 font-mono">Sign in to your SignalHub account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-xs text-zinc-400 font-mono tracking-wide">PASSWORD</label>
                <Link href="/forgot-password" className="text-xs text-orange-400 hover:text-orange-300 font-mono transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-zinc-600 font-mono mt-6">
            Not registered yet?{' '}
            <Link href="/signup" className="text-orange-400 hover:text-orange-300 transition-colors font-semibold">
              Sign Up →
            </Link>
          </p>
        </motion.div>
