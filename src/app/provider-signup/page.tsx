...
const EXPERIENCE_OPTIONS: { key: Experience; label: string; desc: string }[] = [
  { key: "beginner", label: "Beginner", desc: "0–2 years trading experience" },
  {
    key: "intermediate",
    label: "Intermediate",
    desc: "2–5 years, consistent profits",
  },
...
export default function ProviderSignupPage() {
  ...
  const canNext = () => {
    if (step === 1)
      return (
        form.displayName.trim() && form.experience && form.markets.length > 0
      );
    if (step === 2)
      return form.tradingStyle && form.avgWinRate && form.defaultPrice;
  ...
  return (
    <div className="min-h-screen bg-[#080808] flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 w-full flex-1 flex items-center justify-center px-4 py-12">
          ...
          {!done ? (
              ...
              <div className="flex items-center justify-center gap-2 mb-8">
                {STEPS.map((s, i) => (
                  <div key={s.num} className="flex items-center gap-2">
                    ...
                    {i < STEPS.length - 1 && (
                      <div
                        className={`w-8 h-px transition-colors ${step > s.num ? "bg-orange-500" : "bg-[#2a2a2a]"}`}
                      />
                    )}
                  </div>
                ))}
                  ...
                  {step === 1 && (
                    ...
                    >
                      <div className="text-center mb-6">
                        <div className="w-14 h-14 mx-auto mb-3 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center text-2xl shadow-xl shadow-orange-500/20">
                          📡
                        </div>
                  ...
                  {step === 2 && (
                    ...
                    >
                      <div className="text-center mb-6">
                        ...
                        <p className="text-zinc-500 text-xs font-mono mt-1">
                          Help buyers understand your style
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {STYLES.map((style) => (
                            <button
                              key={style}
                              onClick={() => update("tradingStyle", style)}
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1.5">
                          <label className="text-[10px] text-zinc-500 font-mono tracking-widest">
                            AVERAGE WIN RATE
                          </label>
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          {["1–3", "3–7", "7–15", "15+"].map((opt) => (
                            <button
                              key={opt}
                              onClick={() => update("avgSignalsPerWeek", opt)}
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-600 font-mono mt-1.5">
                          You keep 90% · Platform fee: 10% · Min $0.99 · Max
                          $9.99
                        </p>
                      </div>
                    </motion.div>
                  ...
                  {step === 3 && (
                    ...
                    >
                      <div className="text-center mb-6">
                        ...
                        <p className="text-zinc-500 text-xs font-mono mt-1">
                          Add socials and agree to terms
                        </p>
                      </div>

                      {/* Summary card */}
                      <div className="bg-[#0d0d0d] border border-[#1f1f1f] rounded-2xl p-4 space-y-2">
                        <p className="text-[10px] text-zinc-600 font-mono tracking-widest mb-3">
                        ...
                        {[
                          ...
                          {
                            label: "Price",
                            value: `$${form.defaultPrice} per signal`,
                          },
                        ].map((item, i) => (
                          <div
                            key={i}
                          ...
                          >
                            ...
                            <span className="text-zinc-300 text-xs font-mono capitalize">
                              {item.value || "—"}
                            </span>
                          </div>
                        ))}
                      ...
                      <div className="space-y-3">
                        <label className="text-[10px] text-zinc-500 font-mono tracking-widest block">
                          SOCIAL LINKS (optional)
                        </label>
                        <div className="relative">
                          <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-600 text-sm font-mono">
                            𝕏
                          </span>
                          <input
                            value={form.twitter}
                        ...
                        <div className="relative">
                          <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-600 text-sm">
                            ✈
                          </span>
                          <input
                            value={form.telegram}
                      ...
                      >
                        ...
                        <p className="text-xs text-zinc-500 font-mono leading-relaxed">
                          ...
                          , and confirm that my signals are based on genuine
                          market analysis. I understand the platform takes a 10%
                          commission.
                        </p>
                      </button>
                    </motion.div>
            ...
            >
              ...
              <p className="text-zinc-500 text-sm font-mono mb-2">
                ...
                <span className="text-orange-400">{form.displayName}</span>
              </p>
              <p className="text-zinc-600 text-xs font-mono mb-8 max-w-xs mx-auto leading-relaxed">
                Your account is under review. You'll be approved within 24 hours
                and can start posting signals right away.
              </p>
              <div className="space-y-3">
                <Link
                  href="/provider"
